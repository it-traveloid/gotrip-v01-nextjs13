...
export default function HeroHeaderdata() {
	...
	return (
		<>
			...
			{show && (
				<>
					<div className="absolute z-10 top-0 left-0 w-screen h-screen bg-black bg-opacity-40" onClick={handleShow}></div>
					<div className="z-20 absolute text-sm text-text-color-1 -translate-y-1/2 -translate-x-1/2 top-1/2 left-1/2 sm:w-[400px] w-full px-4">
